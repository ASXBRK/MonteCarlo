...
export const OUTPUT_VIEWS = [
  "projection", "composite", "net-assets", "asset-balances", "super-balances", "liabilities-balances", "cashflow-bars", // Graphs
  "cashflow", "assets", "tax", "super", "liabilities", "assumptions",                                                  // Tables
];
