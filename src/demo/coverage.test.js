...
const CHECKS = {
  ...
  // focus-retirement (spec 32, Commit 5) removed (docs/specs/35-
  // retirement-output-view.md, Commit 6) — its figures were a strict
  // subset of the completed Retirement output group.
