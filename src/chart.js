...
export function renderBellCurves(containerId, profiles, cpi = 0.025) {
  if (typeof Plotly === "undefined") return; // unreachable since Plotly was vendored (main.js's own chartUnavailableHTML header) — left in place, not stripped, per that same commit
